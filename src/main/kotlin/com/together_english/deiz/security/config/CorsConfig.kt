    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        val configuration = CorsConfiguration().apply {
            allowedOrigins = listOf(
                ...
                "http://english-together.shop",
                "https://english-together.shop",
                "http://api.english-together.shop",
                "https://api.english-together.shop",
                "http://www.english-together.shop",
                "https://www.english-together.shop",
                "http://localhost:80",
